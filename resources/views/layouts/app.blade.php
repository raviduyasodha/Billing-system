...
<div class="app-shell">
    <header class="app-header">
        ...
        <nav class="app-nav">
            ...
            <a href="{{ route('invoices.index') }}" class="btn-secondary btn">Invoices</a>
            <a href="{{ route('customers.index') }}" class="btn">Customers</a>
            <a href="{{ route('items.index') }}" class="btn-secondary btn">Items</a>
        </nav>
    </header>
